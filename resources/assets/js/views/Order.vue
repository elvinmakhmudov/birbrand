        ...
        <div class="row">
            <div class="col s12">
                ...
                <table class="bordered">
                    <thead>
                    <tr>
                        <th style="width: 3%" class="hide-on-small-and-down">№</th>
                    ...
                    <tr v-for="order in orders">
                        <td class="hide-on-small-and-down">{{ order.id }}</td>
                        <td>
                            <table>
                                <tbody>
                                <tr v-for="product in order.products">
                                    ...
                                    <td style="width: 70%">
                                      <span class="table-order-link"><a :href="'#/product/'+product.id"> {{ product.title}} </a>
                                </span>
                                        <span class="" v-for="option, name in JSON.parse(product.pivot.options|| '[]')">
                                    ...
                                    <td style="width: 30%" v-if="product.pivot.reviewable">
                                        <span>
                                            <a @click.prevent="rateProduct(order.id, product, 'like')" href=""><i
                                                    class="material-icons">thumb_up</i></a>
                                            <a @click.prevent="rateProduct(order.id, product, 'dislike')" href=""><i
