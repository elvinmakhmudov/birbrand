                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select id="select" class="form-control" name="type">
                                    ...
                                    <option value="top-banner" {{ $banner->type == "top-banner" ? "selected" : "" }}>Yuxarı banner</option>
                                    <option value="left-banner" {{ $banner->type == "left-banner" ? "selected" : "" }}>Sol banner</option>
                                    <option value="right-banner" {{ $banner->type == "right-banner" ? "selected" : "" }}>Sağ banner</option>
                                </select>
                            </div>
                        </div>
