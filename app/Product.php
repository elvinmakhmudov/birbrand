...
class Product extends Model implements Buyable
{
     ...
     */
    protected $fillable = [
        'title', 'description', 'price', 'image_url', 'options','old_price', 'sale_percent','is_shown','ordered','likes', 'dislikes', 'rating','note','url'
    ];
    /**
     ...
     */
    protected $hidden = [
        'user_id','note','is_shown','likes','dislikes','created_at','updated_at','trending','url'
    ];
